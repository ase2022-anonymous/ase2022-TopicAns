...
class TrainWholeModel:
	...
	def __read_args_for_config(self, args):
		if args.pretrained_bert_path in ['prajjwal1/bert-small', 'google/bert_uncased_L-6_H-512_A-8',
										 'google/bert_uncased_L-8_H-512_A-8', 'pretrained_model/prajjwal1/bert-small',
										 'pretrained_model/prajjwal1/bert-medium']:
			word_embedding_len = 512
			sentence_embedding_len = 512
		elif args.pretrained_bert_path in ['bert-base-uncased', 'pretrained_model/bert-base-uncased', 'huggingface/CodeBERTa-small-v1']:
